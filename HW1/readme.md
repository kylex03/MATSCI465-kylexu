...
- `assignment_01_output/` and/or `output/`: Data/output folders used by the notebook (includes the example EM image file).
...
3. Launch JupyterLab:
   ```bash
   jupyter lab
4. Open `assignment_01_setup.ipynb` and run cells from top to bottom. Double check the directory of the tif file when running locally.
