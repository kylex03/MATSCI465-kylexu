...
## Contents
- `assignment_02.ipynb` (or your Week 02 notebook): virtual detector framework, diffraction statistics (Itot/CoM/radial profiles), and an analysis pipeline.
...
## How to run locally
1. Activate your environment (e.g., `matsci465`).
2. Launch Jupyter:
   ```bash
   jupyter lab
